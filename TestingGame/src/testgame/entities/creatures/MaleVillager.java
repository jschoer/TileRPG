...
public class MaleVillager extends Creature
{
	...
	public MaleVillager(Handler handler, float x, float y, int width, int height, int movement, ClickListener clicked)
	{
		...
		aniDown = new Animation(200, Assests.maleVillager_down);
		aniUp = new Animation(200, Assests.maleVillager_up);
		aniLeft = new Animation(200, Assests.maleVillager_left);
		aniRight = new Animation(200 ,Assests.maleVillager_right);
